package com.example.wifianalyzer.ui.frag2;
...
public class Frag2Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        int[] colors = {Color.MAGENTA, Color.RED, Color.DKGRAY, Color.GREEN, Color.CYAN, Color.BLUE,
                Color.BLACK, Color.GRAY, Color.LTGRAY, Color.rgb(233, 150, 122)};
        ...
        if (availNetworks.size() > 0) {
            ...
            for (ScanResult availNetwork : availNetworks) {
                ...
                wifiInfoList1.add(
                        new WifiInfo_(dbm, freq, availNetwork.SSID, channel, availNetwork.BSSID,
                                wrappedDrawable));
...
//Animate
        ...
        for (i = 0; i < wifiInfoList.size(); i++) {
            ...
            if (wifiInfoList.get(i) != null) {
                ...
                y.add(new PieEntry(d,
                        d + " dbm" + "\n" + wifiInfoList.get(i).getChannel() + " Chan",
                        wifiInfoList.get(i).getName()));
